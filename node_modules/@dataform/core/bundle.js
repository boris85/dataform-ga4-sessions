...
const dataform = $root.dataform = (() => {
    ...
    dataform.ColumnDescriptor = (function() {
        ...
        ColumnDescriptor.fromObject = function fromObject(object) {
            ...
            default:
                if (typeof object.dimensionType === "number") {
                    message.dimensionType = object.dimensionType;
                    break;
                }
                break;
        ...
        ColumnDescriptor.toObject = function toObject(message, options) {
            ...
            if (message.dimensionType != null && message.hasOwnProperty("dimensionType"))
                object.dimensionType = options.enums === String ? $root.dataform.ColumnDescriptor.DimensionType[message.dimensionType] === undefined ? message.dimensionType : $root.dataform.ColumnDescriptor.DimensionType[message.dimensionType] : message.dimensionType;
            if (message.aggregation != null && message.hasOwnProperty("aggregation"))
                object.aggregation = options.enums === String ? $root.dataform.ColumnDescriptor.Aggregation[message.aggregation] === undefined ? message.aggregation : $root.dataform.ColumnDescriptor.Aggregation[message.aggregation] : message.aggregation;
            if (message.expression != null && message.hasOwnProperty("expression"))
...
function isWarehouseType(input) {
...
(function (SyntaxTreeNodeType) {
    ...
    SyntaxTreeNodeType[SyntaxTreeNodeType["SQL_LITERAL_MULTILINE_STRING"] = 5] = "SQL_LITERAL_MULTILINE_STRING";
    SyntaxTreeNodeType[SyntaxTreeNodeType["SQL_STATEMENT_SEPARATOR"] = 6] = "SQL_STATEMENT_SEPARATOR";
    ...
    concatenate(mutators) {
        ...
        return this.allChildren
            ...
            if (typeof child === "string") {
                return (mutator === null || mutator === void 0 ? void 0 : mutator(child)) || "";
            }
...
function buildSqlxLexer() {
    ...
    const innerTripleSingleQuoteLexer = {};
    ...
    const innerTripleDoubleQuoteLexer = {};
...
function main(encodedCoreExecutionRequest) {
    ...
    compileRequest.compileConfig.filePaths
        .filter(path => path.startsWith(`includes${pathSeperator}`))
        .filter(path => path.split(pathSeperator).length === 2)
        .filter(path => path.endsWith(".js"))
        .forEach(includePath => {
        try {
            topLevelIncludes[baseFilename(includePath)] = require(includePath);
        }
        catch (e) {
    ...
    compileRequest.compileConfig.filePaths
        .filter(path => path.startsWith(`definitions${pathSeperator}`))
